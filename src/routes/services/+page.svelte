<div>
	...
	<div class="grid grid-cols-3 grid-rows-3">
		...
		<div class="card hover:card-hover rounded-l-none rounded-br-none p-8 grid place-items-center">
			Leadership
		</div>
		<div class="card hover:card-hover rounded-none p-8 grid place-items-center">
		...
		<div class="card hover:card-hover rounded-r-none rounded-tl-none p-8 grid place-items-center">
	...
	<div class="card hover:card-hover mt-8 p-4 pb-8">
		...
		<ul class="list-disc pl-20">
			...
			<li>Business Plan and Business Model Preparation</li>
			<li>Research and Survey Works</li>
			<li>Project Implementation Impact Assessment</li>
